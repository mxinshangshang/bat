#!/usr/bin/env python
# encoding: utf-8
# by user @ https://github.com/user/Leetcode-Rust
import requests, os
...
CODE_TEMPLATE = \
"""// Author: user @ https://github.com/user/Leetcode-Rust
// Zhihu: https://www.zhihu.com/people/user
{code}
"""
...
class Leetcode:
    ...
    REPO_URL = 'https://github.com/user/Leetcode-Rust'
    def __init__(self):
...
if __name__ == '__main__':
    ...
    subprocess.run(["git", "commit", "-m", "commit by crawler.py @user at {}".format(datetime.now().strftime("%Y-%m-%d %H:%M"))])
